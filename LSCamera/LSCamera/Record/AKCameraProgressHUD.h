...
@protocol AKCameraProgressHUDDelegate;

typedef enum {
    /** Progress is shown using an UIActivityIndicatorView. This is the default. */
    AKCameraProgressHUDModeIndeterminate,
    /** Progress is shown using a MBRoundProgressView. */
	AKCameraProgressHUDModeDeterminate,
	/** Shows a custom view */
	AKCameraProgressHUDModeCustomView
} AKCameraProgressHUDMode;
...
} AKCameraProgressHUDAnimation;

@interface AKCameraProgressHUD : UIView
{
    AKCameraProgressHUDMode mode;
    AKCameraProgressHUDAnimation animationType;
	...
	id<AKCameraProgressHUDDelegate> __weak delegate;
#elif __has_feature(objc_arc)
	id<AKCameraProgressHUDDelegate> __unsafe_unretained delegate;
#else
	id<AKCameraProgressHUDDelegate> delegate;
#endif
    NSString *labelText;
 ...
 */
+ (AKCameraProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated;
 ...
 */
@property (assign) AKCameraProgressHUDMode mode;
 ...
 */
@property (assign) AKCameraProgressHUDAnimation animationType;
 ...
 */
#if __has_feature(objc_arc_weak)
@property (weak) id<AKCameraProgressHUDDelegate> delegate;
#elif __has_feature(objc_arc)
@property (unsafe_unretained) id<AKCameraProgressHUDDelegate> delegate;
#else
@property (assign) id<AKCameraProgressHUDDelegate> delegate;
#endif
...
@protocol AKCameraProgressHUDDelegate <NSObject>
 ...
 */
@interface AKRoundProgressView : UIView {
@private
    float _progress;
}
